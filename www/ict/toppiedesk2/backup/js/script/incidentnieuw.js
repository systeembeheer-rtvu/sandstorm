...
$(function(){
    ...
    $('document').ready(function(){
        ...
        $('#asset').click(function(){
            window.open('toppiedesk.php?id=stats&stat=incidentenperhardware&naam=' + $('input[name="asset"]').val() + '&submit=Toon', 'Incidenten_van_gebruiker');
        });
        ...
        $('a[name="print"]').click(function(){
            window.open('toppiedesk.php?id=incidentprint&searchoid=' + $('input[name="oid"]').val(), 'Incidenten_van_gebruiker');
        });
