<?php
    class IncidentenPerHardware extends abstractStats
    {
        function __construct()
        {
            $this -> menutitle = "Incidenten per asset";
            $this -> pagetitle = "";
            $this -> pageid = "incidentenperhardware";
            $this -> template = "";
        }
    ...
    $page['stats']['classes'][$classcounter++] = new IncidentenPerHardware();
?>