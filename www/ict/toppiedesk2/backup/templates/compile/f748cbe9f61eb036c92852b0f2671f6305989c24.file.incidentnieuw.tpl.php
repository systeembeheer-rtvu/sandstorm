...
<?php if ($_valid && !is_callable('content_4efb0d0576ac0')) {function content_4efb0d0576ac0($_smarty_tpl) {?><div class="formulier">
    <!--<h1>Incident
...
" name="mail"><img src="img/mail_generic.png" /></a>
    ...
    <form action="toppiedesk.php?id=callnieuw" <?php if ($_smarty_tpl->tpl_vars['output']->value['incident']['id']!=0){?>class="selected"<?php }?> name="incident" id="dataform" method="post">
        <table>
            <tr>
