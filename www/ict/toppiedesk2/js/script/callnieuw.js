...
$(function(){
	...
	$(window).unload(function(){
	    if (window.opener.location.href.indexOf("id=calloverzicht") > 0 || window.opener.location.href.substr(-13) == "turbodesk.php" || window.opener.location.href.substr(-14) == "toppiedesk.php")
	    {
