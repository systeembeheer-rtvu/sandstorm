<?php /* Smarty version Smarty-3.1.8, created on 2012-08-10 14:25:49
         compiled from "templates/default\projectzoeken.tpl" */ ?>
<?php /*%%SmartyHeaderCode:45884f476d3b2915b4-73140972%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '27e9ac70486ba6a1f2d12d21230fdfbbc103495e' => 
    array (
  ...
  'nocache_hash' => '45884f476d3b2915b4-73140972',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.8',
  'unifunc' => 'content_4f476d3b33134',
  'variables' => 
  array (
    'output' => 0,
    'behandelaar' => 0,
...
<?php if ($_valid && !is_callable('content_4f476d3b33134')) {function content_4f476d3b33134($_smarty_tpl) {?><div class="formulier">
...
" <?php if ($_smarty_tpl->tpl_vars['behandelaar']->value['selected']=="true"){?>selected="selected"<?php }?>><?php echo $_smarty_tpl->tpl_vars['behandelaar']->value['naam'];?>
            ...
            <tr>
                <td colspan="2">
                    <input type="checkbox" name="aangemeld" <?php if ($_smarty_tpl->tpl_vars['output']->value['search']['aangemeld']=="on"){?> checked <?php }?> id="aangemeld" /> <label for="aangemeld">Openstaande projecten weergeven</label><br />
                    <input type="checkbox" name="afgemeld" <?php if ($_smarty_tpl->tpl_vars['output']->value['search']['afgemeld']=="on"){?> checked <?php }?> id="afgemeld" /> <label for="afgemeld">Gesloten projecten weergeven</label><br />
                </td>
            </tr>
            <tr>
...
'
                >
                    ...
                    <td><?php echo $_smarty_tpl->tpl_vars['project']->value['aangemaaktop'];?>
</td>
                    <td><?php echo $_smarty_tpl->tpl_vars['project']->value['geslotenop'];?>
</td>
                </tr>
            <?php } ?>
        <?php }else{ ?>
