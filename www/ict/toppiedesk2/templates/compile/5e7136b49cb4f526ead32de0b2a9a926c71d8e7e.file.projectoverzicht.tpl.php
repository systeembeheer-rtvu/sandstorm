<?php /* Smarty version Smarty-3.1.8, created on 2012-05-18 11:26:15
         compiled from "templates/default\projectoverzicht.tpl" */ ?>
<?php /*%%SmartyHeaderCode:185374f476ca0d73092-60964437%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '5e7136b49cb4f526ead32de0b2a9a926c71d8e7e' => 
    array (
  ...
  'nocache_hash' => '185374f476ca0d73092-60964437',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.8',
  'unifunc' => 'content_4f476ca0e2732',
  'variables' => 
  array (
    'output' => 0,
    'behandelaar' => 0,
...
<?php if ($_valid && !is_callable('content_4f476ca0e2732')) {function content_4f476ca0e2732($_smarty_tpl) {?><div class="formulier">
...
" <?php if ($_smarty_tpl->tpl_vars['behandelaar']->value['selected']=="true"){?> selected="selected" <?php }?> ><?php echo $_smarty_tpl->tpl_vars['behandelaar']->value['naam'];?>
	...
	<div id="resultaten">
		<table id="table">
			<tr>
				<thead>
					<td><a href="?id=projectoverzicht&medewerker=<?php echo $_smarty_tpl->tpl_vars['output']->value['currentid'];?>
&sortCol=titel&sortOrder=<?php if ($_smarty_tpl->tpl_vars['output']->value['sort']['column']=="p.titel"){?><?php echo $_smarty_tpl->tpl_vars['output']->value['sort']['order'];?>
<?php }else{ ?>asc<?php }?>"> Titel</a></td>
					<td><a href="?id=projectoverzicht&medewerker=<?php echo $_smarty_tpl->tpl_vars['output']->value['currentid'];?>
&sortCol=deadline&sortOrder=<?php if ($_smarty_tpl->tpl_vars['output']->value['sort']['column']=="p.deadline"){?><?php echo $_smarty_tpl->tpl_vars['output']->value['sort']['order'];?>
<?php }else{ ?>asc<?php }?>">Deadline</a></td>
					<td>Medewerkers</td>
					<td>Geplande tijd</td>
					<td>Bestede tijd</td>
				</thead>
