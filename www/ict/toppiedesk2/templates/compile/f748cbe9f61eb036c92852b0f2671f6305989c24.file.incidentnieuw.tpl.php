<?php /* Smarty version Smarty-3.1.8, created on 2012-10-19 21:04:44
         compiled from "templates/default/incidentnieuw.tpl" */ ?>
<?php /*%%SmartyHeaderCode:12010636334efb0d054fcc28-46318032%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f748cbe9f61eb036c92852b0f2671f6305989c24' => 
    array (
  ...
  'nocache_hash' => '12010636334efb0d054fcc28-46318032',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.8',
  'unifunc' => 'content_4efb0d0576ac0',
  'variables' => 
  array (
    'output' => 0,
    'i' => 0,
...
<?php if ($_valid && !is_callable('content_4efb0d0576ac0')) {function content_4efb0d0576ac0($_smarty_tpl) {?><div class="formulier" style="width: 99%;">
...
" <?php if ($_smarty_tpl->tpl_vars['output']->value['incident']['status']==$_smarty_tpl->tpl_vars['status']->value['id']){?> selected="selected" <?php }?> ><?php echo $_smarty_tpl->tpl_vars['status']->value['status'];?>
						...
						<?php if ($_smarty_tpl->tpl_vars['output']->value['userid']==4||$_smarty_tpl->tpl_vars['output']->value['userid']==7){?>
							<input type="submit" style="background-color: #00aa00;" name="opslaan" value="Opslaan" />
							<input type="submit" style="background-color: #ff0000;" name="o&a" value="Afmelden" />
						<?php }else{ ?>
