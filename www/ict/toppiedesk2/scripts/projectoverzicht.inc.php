<?php
    $page['classes']['load'] = new configcontract();    class configcontract
    {
        function GetFileName()
        {
            return "projectoverzicht";
        }
        ...
        function GetVars()
        {
		    ...
		    "sortColumn" => array("sortCol", "get", ""),
		    "sortOrder" => array("sortOrder", "get", "")
                )
            );
        }
	    ...
	    if($input['medewerker'] == "")
            {
                $input['medewerker'] = $_COOKIE['behandelaar'];
            }

            $output['currentid'] = $input['medewerker'];
	    ...
	    else if($input["sortColumn"] == "deadline")
	    {
		$sort = "p.deadline";
	    ...
	    $output["sort"]["column"] = $sort;
	    $output["sort"]["order"] = $sortorder;
